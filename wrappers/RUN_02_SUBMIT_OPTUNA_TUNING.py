...
def main():
    ...
    ssh(f"cd {REMOTE_ROOT} && mkdir -p outputs/slurm && sbatch slurm/optuna.sbatch")
    print("Submitted short Optuna tuning. It is resume-friendly through outputs/optuna/study.db.")
