...
def main():
    ...
    ssh(f"cd {REMOTE_ROOT} && mkdir -p outputs/slurm && sbatch slurm/smoke.sbatch")
    print("Submitted smoke test. Use RUN_06_REMOTE_STATUS.py to check it, then RUN_05_SYNC_RESULTS_TO_GITHUB.py after completion.")
